...
export const SearchWithFilter = () => {
  return (
    ...
    dark:text-gray-300 
    outline-none focus:outline-none w-full sm:w-5/6">
        {/* <h1>hola</h1> */}
    <div className="relative flex">
        <select 
            ...
            <option className="font-medium cursor-pointer" value="filter">Especies</option>
            <option className="font-medium cursor-pointer" value="filter">Estados</option>
            <option className="font-medium cursor-pointer" value="filter">Zoologicos</option>
            <option className="font-medium cursor-pointer" value="filter">Acuarios</option>
        </select>
        <input 
            type="search" 
            name="search"
